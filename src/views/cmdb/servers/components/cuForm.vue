<template>
  <el-dialog :visible.sync="dialogVisible" :title="curId ? '编辑服务器' : '新增服务器'" width="700px" :before-close="close">
    <el-form ref="ruleForm" label-position="left  " :model="ruleForm" status-icon :rules="rules" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="父服务器" prop="pid">
        <treeselect
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sign: [{ required: true, trigger: 'blur', message: '服务器标识不能为空' }],
